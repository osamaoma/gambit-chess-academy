...
export class EndgameDetector extends SignalDetector<EndgameSignals> {
  ...
  protected explain(ctx: MoveContext): Omit<Explanation, 'improvements'> {
    ...
    switch (s.kind) {
      case 'promotion':
        return { headline: `${san} promotes.`, tags,
      ...
      case 'promotion-threat':
        return { headline: `${san} threatens to promote.`, tags,
      ...
      case 'outside-passer':
        return { headline: `${san} creates an outside passed pawn.`, tags,
      ...
      case 'opposition':
        return { headline: `${san} takes the opposition.`, tags,
      ...
      case 'rook-activity':
        return s.subject === 'seventh'
          ? { headline: `${san} lifts the rook to the seventh.`, tags,
          ...
          : { headline: `${san} puts the rook behind the passer.`, tags,
      ...
      case 'king-activity':
        return { headline: `${san} activates the king.`, tags,
      ...
      case 'pawn-race':
        return { headline: `${san} pushes in the pawn race.`, tags,
      ...
      case 'fortress':
        return { headline: `${san} holds the fortress.`, tags,
      ...
      case 'passive-king':
        return { headline: `${san} leaves the king passive.`, tags,
